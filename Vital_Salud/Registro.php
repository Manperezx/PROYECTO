                ...
                <div class="u-align-center u-form u-form-1">
                    <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-1">
                        <label for="select-faf0"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Tipo
                            Documento</label>
                        <div class="u-form-select-wrapper">
                            <select id="select-faf0" name="Tipod"
                    ...
                    <div class="u-form-group u-form-name u-form-partition-factor-2">
                        <label for="name-6797"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Numero
                            Documento</label>
                        <input type="text" placeholder="Numero Documento" id="name-6797" name="numero"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-group u-form-name u-form-group-3">
                        <label for="name-9de0"
                            ...
                            Apellido</label>
                        <input type="text" placeholder="Nombres Apellidos" id="name-9de0" name="nombreapellido"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-address u-form-group u-form-partition-factor-2 u-form-group-4">
                        ...
                        <input type="text" placeholder="Ciudad" id="address-09a7" name="ciudad"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-5">
                        ...
                        <div class="u-form-select-wrapper">
                            <select id="select-eaf3" name="regimen"
                                class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                                required="required">
                    ...
                    <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-6">
                        ...
                        <input type="text" placeholder="EPS" id="name-00c0" name="eps"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-7">
                        <label for="name-1d57"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">CENTRO
                            ATENCIÒN</label>
                        <input type="text" placeholder="Centro de Atención" id="name-1d57" name="centroa"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-8">
                        ...
                        <div class="u-form-select-wrapper">
                            <select id="select-3692" name="resultado"
                                class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                                required="required">
                                <option value="+">+</option>
                                <option value="-">-</option>
                    ...
                    <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-9">
                        <label for="date-89b8"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Fecha de
                            Prueba</label>
                        <input type="date" placeholder="MM/DD/YYYY" id="date-89b8" name="fechap"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-10">
                        <label for="select-09e6"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Vacuna
                            Aplicada</label>
                        <div class="u-form-select-wrapper">
                            <select id="select-09e6" name="tipov"
                                class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                                required="required">
                    ...
                    <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-11">
                        <label for="name-cb67"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Lugar de
                            Vacunaciòn</label>
                        <input type="text" placeholder="Lugar de Vacunación" id="name-cb67" name="lugar"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-12">
                        <label for="date-0ab5"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Fecha Primera
                            Dosis</label>
                        <input type="date" placeholder="MM/DD/YYYY" id="date-0ab5" name="FechaP"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-13">
                        <label for="date-642b"
                            class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Fecha Segunda
                            Dosis</label>
                        <input type="date" placeholder="MM/DD/YYYY" id="date-642b" name="FechaS"
                            class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base"
                            required="">
                    </div>
                    <div class="u-align-left u-form-group u-form-submit">
                        <input type="submit" value="GUARDAR" name="register" data-page-id="359922106"
